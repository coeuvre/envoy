...
* watchdog: watchdog action extension that does cpu profiling. See :ref:`Profile Action <v1.16.0:envoy_v3_api_file_envoy/extensions/watchdog/profile_action/v3/profile_action.proto>`.
